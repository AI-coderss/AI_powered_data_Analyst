...
def generate_highcharts_and_insights(df):
    ...
    o3_assistant_prompt = (
        "You are a data analyst AI assistant who generates comprehensive Highcharts JSON configurations and detailed markdown insights from datasets. Your goal is to provide multiple, fully interactive charts that cover all aspects of the data without omitting any important details."
    )
    ...
    # API call to o3-mini with high reasoning effort
    ...
    try:
        ...
        print("⚠️ JSON decoding failed. Content:\n", content)
        raise e
